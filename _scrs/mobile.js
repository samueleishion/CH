...
function selectVisualizationType() {
	$('.options .icon#pointer').click(function() { 
		$(this).css('color','#ff00f5'); 
		$('.options .icon#heat').css('color','#fff'); 
	}); 
	
	$('.options .icon#heat').click(function() { 
		$(this).css('color','#ff00f5'); 
		$('.options .icon#pointer').css('color','#fff'); 
	}); 
}
...
$(document).ready(function() {
	...
	var search = $('.search');
    search.width($(document).width-110+'px'); 
    
    $('.icon#settings').click(function() { 
        bringToFront($('.myView#settings')); 
    }); 
